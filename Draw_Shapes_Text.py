...
cv2.rectangle(img,(225,100),(325,200),(0,0,255),cv2.FILLED)
cv2.circle(img,(50,350),50,(255,0,0),3)
cv2.putText(img,"By Anup",(155,80),cv2.FONT_HERSHEY_COMPLEX,1,(0,100,0),1)
